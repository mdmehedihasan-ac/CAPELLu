...
export default function PageHero({ title, subtitle, image }) {
  return (
    <section className="px-3 pb-4 pt-16 md:px-5 md:pb-8 md:pt-36 lg:pt-44">
      <div className="container-shell">
        <div className="relative overflow-hidden rounded-[2.2rem] bg-sage-950 text-white shadow-[0_40px_100px_-60px_rgba(26,31,22,0.8)]">
          ...
          <div className="relative z-10 min-h-[280px] px-5 py-8 md:min-h-[420px] md:px-10 md:py-14 lg:px-14 lg:py-16">
            <div className="flex h-full max-w-3xl flex-col justify-end">
              ...
              <motion.h1
                ...
                className="mt-3 font-display text-4xl font-medium tracking-[-0.04em] text-white md:mt-4 md:text-6xl lg:text-7xl"
              >
                {title}
              </motion.h1>
            </div>
